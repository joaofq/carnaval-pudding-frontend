    ...
    <section className="visitors">
      ...
      <div className="section__container">
        ...
        <div
          ...
          aria-label="avaliação por faixa de renda"
        >
          <AvalAgeChart />
        </div>
      </div>
      ...
      <div className="section__container">
        ...
        <div
          className="section__chart"
          aria-label="avaliação geral por nível de gastos"
        >
          <AvalSpentChart />
        </div>
      </div>
      ...
      <div className="section__container">
        ...
        <div
          className="section__chart"
          aria-label="percentual de foliões por região"
        >
          <PeoplesRegionChart />
        </div>
      </div>
      <div className="section__container reverse">
        <div
          className="section__chart"
          aria-label="meios de transporte utilizados pelos visitantes"
        >
      ...
      <div
        className="big-chart"
        aria-label="gastos dos visitantes por categoria"
      >
